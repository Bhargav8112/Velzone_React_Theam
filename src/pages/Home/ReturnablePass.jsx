  ...
  const handleAddEntry = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        pendingqty: 0,
        copytypeconfirm: 0,
        Material_Shape:   " " ,  // Ensure consistency
        Material_Grade:    " ",  // Ensure consistency
        hsn: " ",
        processType: " ",
        packagingType: " ",
        packagingQty: " " || 0,
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header align-items-center d-flex">
                <h4 className="card-title mb-0 flex-grow-1">Returnable Form</h4>
              </div>
